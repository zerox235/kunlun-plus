...
import kunlun.spring.hystrix.support.RequestContextHystrixConcurrencyStrategy;
...
@ConditionalOnProperty(name = "kunlun.spring.hystrix.request-transfer", havingValue = "true")
