 ...
 * @author Kahle
 */
public abstract class AbstractHutoolSmallExcelImportAction<P, D>
        extends AbstractImportExportAction<P, D> implements ImportHandler<P, D> {
    private static Logger log = LoggerFactory.getLogger(AbstractHutoolSmallExcelImportAction.class);

    public AbstractHutoolSmallExcelImportAction(String actionName) {
