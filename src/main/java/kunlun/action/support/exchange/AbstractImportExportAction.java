 ...
 * @author Kahle
 */
public abstract class AbstractImportExportAction<P, D>
        extends AbstractAsyncAction implements ImportExportHandler<P, D> {

    public AbstractImportExportAction(String actionName) {
