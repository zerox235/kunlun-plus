 ...
 * @author Kahle
 */
public abstract class AbstractEasyExcelByteArrayBasedExportAction<P, D>
        extends AbstractImportExportAction<P, D> implements ExportHandler<P, D> {
    private static final Logger log = LoggerFactory.getLogger(AbstractEasyExcelByteArrayBasedExportAction.class);

    public AbstractEasyExcelByteArrayBasedExportAction(String actionName) {
